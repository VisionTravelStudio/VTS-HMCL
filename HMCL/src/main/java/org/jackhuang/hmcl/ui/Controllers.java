...
public final class Controllers {
    public static final int MIN_WIDTH = 1298; // bg width + border width*2 + shadow width*2    1298px
    public static final int MIN_HEIGHT = 736; // bg height + border width*2 + toolbar height + shadow width*2    778px
