...
public final class Controllers {
    public static final int MIN_WIDTH = 1280; // bg width + border width*2 + shadow width*2    1298px
    public static final int MIN_HEIGHT = 720 + 2 + 40 + 16; // bg height + border width*2 + toolbar height + shadow width*2    778px
